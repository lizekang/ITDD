...
class RNNDecoderBase(nn.Module):
    ...
    def forward(self, tgt, memory_bank, memory_lengths=None,
                step=None, knowledge_encoding=None):
        """
        Args:
        ...
        dec_state, dec_outs, attns = self._run_forward_pass(
            tgt, memory_bank, knowledge_encoding=knowledge_encoding, memory_lengths=memory_lengths)
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, memory_lengths=None, knowledge_encoding=None):
        """
        ...
        for _, emb_t in enumerate(emb.split(1)):
            ...
            decoder_input = torch.cat([emb_t, input_feed]+[_fix_enc_hidden(enc_hid) for enc_hid in knowledge_encoding], 1)
